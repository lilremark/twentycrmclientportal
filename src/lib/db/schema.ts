...
export const applicationSettings = pgTable("application_setting", {
  ...
  twentyAutoFormatUrl: boolean("twenty_auto_format_url").default(true).notNull(),
  ...
  googleOauthEnabled: boolean("google_oauth_enabled").default(false).notNull(),
  googleOauthClientId: text("google_oauth_client_id"),
  googleOauthClientSecret: text("google_oauth_client_secret"),
  googleOauthHostedDomain: text("google_oauth_hosted_domain"),
  customOauthEnabled: boolean("custom_oauth_enabled").default(false).notNull(),
  customOauthName: text("custom_oauth_name"),
  customOauthClientId: text("custom_oauth_client_id"),
  customOauthClientSecret: text("custom_oauth_client_secret"),
  customOauthDiscoveryUrl: text("custom_oauth_discovery_url"),
  customOauthAuthorizationUrl: text("custom_oauth_authorization_url"),
  customOauthTokenUrl: text("custom_oauth_token_url"),
  customOauthUserInfoUrl: text("custom_oauth_user_info_url"),
  customOauthIssuer: text("custom_oauth_issuer"),
  customOauthScopes: text("custom_oauth_scopes"),
  customOauthPkce: boolean("custom_oauth_pkce").default(true).notNull(),
  ...timestamps,
});
